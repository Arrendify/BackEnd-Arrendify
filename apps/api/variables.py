def contenido_pdf(info,comentario):
    
    contenido_html_resultado = (
                    """
               <html>
                <head>
                    <style>
                ...
                <body>
                   ...
                   <br>
                    ...
                    <p>Tenemos noticias acerca de la investigación que solicito para la contratación de nuestros servicios.</p>
                    <p>Por lo cual le informo que su solicitud fue <b>DECLINADA.</b></p>
                    """
                    f'<p>Debido a: {comentario}.</p>'
                    """
                    <p>En el archivo adjunto, encontrará todos los detalles y la información relevante relacionada con el resultado de la investigación. Hemos realizado una evaluación exhaustiva y hemos tenido en cuenta diversos factores para proporcionarle un resultado preciso y justo.</p>
                    <p>Agradezco su interés en nuestros servicios y espero que este resultado de investigacion sea útil para usted.</p>
                    <br>
                    <p>Le agradezco su atención.</p>
                    <br>
...
def contenido_pdf_aprobado(info,estatus):
    if estatus == "Aprobado" or estatus == "Aprobado_pe":
        contenido_html_resultado = (
                    """
               <html>
                <head>
...
def contenido_pdf_aprobado_GS(info,estatus):
    if estatus == "Aprobado" or estatus == "Aprobado_pe":
        contenido_html_resultado = (
                    """
               <html>
                ...
                <body>
                   ...
                   <br>
                    ...
                    <br>
                    """
                    f"<p>Derivado a lo anterior, nos complace informarle que el prospecto {info.nombre_arrendatario} ha cumplido con los requisitos solicitados por ARRENDIFY, declarando la presente investigación como POSITIVO, de acuerdo a lo establecido en EL REPORTE DE INVESTIGACIÓN, documento en donde podrá conocer más a detalle sobre el prospecto.</p>"                    
                    """
                    <br>
                    <p>Agradecemos su preferencia en cuanto a la contratación de nuestros servicios, sin más por el momento, quedamos en espera de cualquier duda o aclaración que requiera de nuestra parte, le dejamos nuestros números de contacto al pie de este correo..</p>
                    <br>
               ...
               <html>
                ...
                <body>
                   ...
                   <br>
                    ...
                    <br>
                    """
                    f"<p>Derivado a lo anterior, lamentamos informarle que el prospecto {info.nombre_arrendatario} no ha cumplido con los requisitos solicitados por ARRENDIFY, declarando la presente investigación como DECLINADO, de acuerdo a lo establecido en EL REPORTE DE INVESTIGACIÓN, documento en donde podrá conocer más a detalle sobre el prospecto.</p>"                    
                    """
                    <br>
                    <p>Agradecemos su preferencia en cuanto a la contratación de nuestros servicios, esperando seguir trabajando en este proyecto durante un largo periodo de tiempo, deseando poder cumplir con las expectativas planteadas.</p>
...
def contenido_pdf_investigaciones(info):
...
def contenido_pdf_aprobado_francis(info,estatus):
    if estatus == "Aprobado" or estatus == "Aprobado_pe":
        contenido_html_resultado = (
                    """
               <html>
                ...
                <body>
                   ...
                   <br>
                    ...
                    f'<h1>Estimado Francis Calete </h1>' 
...
def codigo_inmobiliaria(codigo):  
  correo_code_inmobiliaria = (
              """
              <html>
              <head>
                  <style>
              ...
              <body>
                  ...
                  <h1>Bienvenido</h1>
                  <h1>Este es tu código de inmobiliaria</h1>
                  """
                  
                  f'<h2>Tu Código es:</h2>' 
                  f'<h1><b>{codigo}</b></h1>'
                  
                  """
                  <br>
                  <p>Proporciónaselo a tu agente para que puedan registrarse.</p>
                  <br>
                  <hr style="color: #0056b2;" />
                  <table>
                    <tbody><tr>
...
def renovacion_fraterna(con_ren):
    print('con_ren_variables',con_ren)
    arrendatario = con_ren.residente.nombre_arrendatario
    residente = con_ren.residente.nombre_residente
    print(residente)
    cama = con_ren.cama
    print(cama)
    no_depa = con_ren.no_depa
    print(no_depa)
    renovacion_fraterna_html = (
               ...
               <html>
                ...
                <body>
                   ...
                   <br>
                    ...
                    f'<p>Esperamos se encuentre bien, el motivo de este correo es para informarle que se acerca la finalizacion de la poliza a nombre del arrendatario <b>{arrendatario}.</b></p>'
                    
                    
                    f'<p>Derivado a lo anterior, le comparto los datos del contrato<b> Cama: {cama}, No. Departamento: {no_depa}, Residente: {residente}.</b></p>'
                    
                    """
                                     
                    <p>Agradecemos su preferencia en cuanto a la contratación de nuestros servicios, esperando que renueve su políza para seguir trabajando de manera fructifera en este proyecto durante un largo periodo de tiempo.</p>
                 ...
                 """)
    return renovacion_fraterna_html

def renovacion_aviso_fraterna(con_ren):
    print('con_ren_variables',con_ren)
    arrendatario = con_ren.residente.nombre_arrendatario
    print(arrendatario)
    residente = con_ren.residente.nombre_residente
    print(residente)
    aviso_renovacion_fraterna_html = (
               ...
               <html>
                ...
                <body>
                   ...
                   <br>                    
                    ...
                    f'   <h1>Aviso de renovación de el contrato de FRATERNA VS <b>{arrendatario}</b>.</h1>'
                    
                    
                    f'<p>Por favor ponte en contacto a la brevedad con <b>JOAQUIN.</b> para realizar la renovacion de su contrato de arrendamiento</p>'
                    f'<p>Residente: <b>{residente}</b></p>'
                    f'<p>Arrendatario: <b>{arrendatario}</b></p>'
                    
                    """
                                     
                    <p>Sin más por el momento, esperamos se lleve acabo la renovacion de su contrato.</p>
                    <br>
                    <hr style="color: #0056b2;" />
                    <table>
                      <tbody><tr>
                 ...
                 """)
    return aviso_renovacion_fraterna_html
  
def contenido_pdf_aprobado_semillero(info,estatus):
  if estatus == "Aprobado" or estatus == "Aprobado_pe":
      contenido_html_resultado = (
                  """
              <html>
