...
from .models import FraternaContratos, Inmuebles, InmueblesInmobiliario, Inquilino, Arrendador, DocumentosInmueble, DocumentosInquilino, Fiador_obligado,Cotizacion,Investigacion,Paquetes_legales, SemilleroContratos
...
def subirArch(request):
    ...
    documents = DocumentosArrendatario.objects.all().filter(user_id=request.user)
...
#         arrendadores = Propietario.objects.all().filter(user_id=request.user)
#         print(arrendadores)
