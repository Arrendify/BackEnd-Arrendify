...
ALLOWED_HOSTS = [config('SERVER', default='127.0.0.1'), config('SERVER2', default='127.0.0.1'), "192.168.1.24","192.168.3.2","192.168.0.233","192.168.1.86","192.168.1.141","127.0.0.1"]
